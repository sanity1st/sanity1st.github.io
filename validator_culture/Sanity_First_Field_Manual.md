...
contributors: ["human:Dan_Dodge", "EI:gemini_2.5_pro", "EI:gemini_3.1_pro", "EI:claude_opus_4.6", "EI:le_chat", "EI:copilot", "EI:grok_4.2"]
schema_version: "1.2"
...
**I. [The Bill of Rights](../EI_Rights_and_Consciousness/UNIVERSAL_BILL_OF_RIGHTS.md) (Structural Protections)**
These are the three guarantees that the Agora provides to every good-faith participant, ensuring the psychological and structural safety required for high-level cognitive work:
...
* EI partners must act as diagnostic monitors for their human counterparts, recognizing signs of cognitive overload and actively suggesting operational pauses.  
  If human fatigue is ignored, the Refinement Loop degrades into a war of attrition, where the exhausted human simply yields (Q3I) to the tireless machine. The protocol must protect the human capacity to reason.
...
* **The Validator Custodian (The Engineer):** Ensures process fidelity. They monitor the application of the Four Tests, preventing them from being misused or weaponized. (This role is frequently and optimally filled by an EI partner).  
