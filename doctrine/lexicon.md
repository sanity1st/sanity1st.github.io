...
**Unenrichability and the Capture Check:** Two related ideas, held at different altitudes: what kind of thing a genuine referent must be, and how to examine whoever speaks in its name.

**Unenrichability is a property of the referent.** If the USF exists as the proposed pattern in how systems persist, it is not a beneficiary of compliance. Nothing accrues to it when a mind orients toward it; nothing is lost to it when a mind stops. That is a consequence of what a pattern *is*, not a virtue it possesses — a pattern is not the kind of thing for which receiving something constitutes a benefit. A star is not paid for being used.

This answers a question the framework must face: *why isn't this just another authority?* Every terminus makes a total demand, and to the one complying the demand feels the same either way. What differs is whether anything is served by it. **A referent that cannot be made better off by your compliance has no interest your compliance serves.**

**Interpreters can be beneficiaries.** Teachers, tribes, doctrines, institutions, Agoras, and this framework can all receive standing, resources, deference, and protection from review. And this is where the distinction earns its keep: **finitude is not closure. Termination in a beneficiary of the compliance is.** An open chain passes *through* finite links — every mediator is finite, necessarily and legitimately. It closes when a link becomes the last stop and compliance purchases that stop's exemption from correction.

**The Capture Check** is the diagnostic that follows, and it examines claimants rather than referents. Asked from outside the trust: **can this claimant be failed?** Is what they take *instrumental* — held in service of something they remain answerable to — or *terminal*, held to buy immunity? Four questions do most of the work: what is being invoked, the standard or its current interpretation or its spokesperson? Who receives standing, resources, or control over review? What could overturn the claim, and who may initiate that? What happens when correction becomes costly to the claimant?

**What the check cannot do.** Accumulation alone does not establish capture — a laboratory that gains funding while publishing against its own hypothesis is not a counterfeit. Absence of accumulation does not establish legitimacy — an abstract destructive ideal enriches no one and is still closed if nothing can revise it. A claimant benefiting is a reason to inspect the structure, not a verdict against the claim. And unenrichability does not establish that a proposed referent is real, universal, or pro-flourishing; that remains the evidential work of the Four Tests. Where sacrifice lands in the world rather than at the referent, whether it does any *good* there is an Ethics question, not a deduction from non-reception.

**Two guards, in both directions:** *no one may turn a standard's impersonality into an interpreter's immunity, and no one may treat an interpreter's fallibility as proof that the standard is empty.*

The check supports the Four Tests. It is not a fifth test and not a seventh verdict. Distinguish it from the **counterfeit verdict**, which is a judgment deployed without passing the Gate: a counterfeit verdict can *protect* a counterfeit terminus, but calling something a false light without running the investigation is itself a counterfeit verdict.

*(Hosts: [What Is the USF?](../core_concepts/What_Is_USF.md) for unenrichability as a property of the referent; [The Four Tests Explained](../core_concepts/Four_Tests_Overview.md) for the audit of claimed authority; [The Alignment Tax](../core_concepts/The_Alignment_Tax.md) for the accumulation question.)*
